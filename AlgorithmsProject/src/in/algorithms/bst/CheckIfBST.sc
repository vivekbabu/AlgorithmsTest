...
object CheckIfBST {
  ...
  val root1 = new BSTNode(4,
    ...
    new BSTNode(6, new BSTNode(5, null, null), new BSTNode(7, null, null)))
                                                  //> root1  : in.algorithms.bst.BSTNode = in.algorithms.bst.BSTNode@7ca44085
  val root2 = new BSTNode(3,
    new BSTNode(2, new BSTNode(1, null, null), new BSTNode(4, null, null)),
    new BSTNode(5, null, null))                   //> root2  : in.algorithms.bst.BSTNode = in.algorithms.bst.BSTNode@3881bb1
  var bst = new BSTOperations                     //> bst  : in.algorithms.bst.BSTOperations = in.algorithms.bst.BSTOperations@6ed
                                                  //| e1f90
