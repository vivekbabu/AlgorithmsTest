...
object CheckIfBST {
  ...
  val root1 = new BSTNode(4,
    ...
    new BSTNode(5, null, null))                   //> root1  : in.algorithms.bst.BSTNode = in.algorithms.bst.BSTNode@76c0fd31
    val root2 = new BSTNode(3,
    new BSTNode(2, new BSTNode(1, null, null), new BSTNode(4, null, null)),
    new BSTNode(5, null, null))                   //> root2  : in.algorithms.bst.BSTNode = in.algorithms.bst.BSTNode@782ed8df
    var bst = new BSTOperations                   //> bst  : in.algorithms.bst.BSTOperations = in.algorithms.bst.BSTOperations@256
                                                  //| 48263
