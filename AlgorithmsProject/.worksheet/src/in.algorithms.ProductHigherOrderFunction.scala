...
object ProductHigherOrderFunction {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(102); 
  ...
  def fact(x: Int): Int = {
    ...
    factWithLoop(x, 1)
  };System.out.println("""fact: (x: Int)Int""");$skip(291); 
  ...
  product(cube)(1, 4);System.out.println("""res3: Int = """ + $show(res$3));$skip(31); val res$4 = 
