...
object DFS {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(113); 
  ...
  var graph = Map(0 -> Set[Int](1),
    ...
    4 -> Set[Int](3),
    5 -> Set[Int](),
    6 -> Set[Int](0));System.out.println("""graph  : scala.collection.immutable.Map[Int,scala.collection.immutable.Set[Int]] = """ + $show(graph ));$skip(517); 
