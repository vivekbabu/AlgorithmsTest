...
object Sheet {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(124); 
  ...
  def cube(x: Int): Int = x * x * x;System.out.println("""cube: (x: Int)Int""");$skip(35); 
   def square(x: Int): Int = x * x;System.out.println("""square: (x: Int)Int""");$skip(26); 
  def id(x: Int): Int = x;System.out.println("""id: (x: Int)Int""");$skip(438); 
/*  def sum(f: Int => Int, a: Int, b: Int): Int = {
 ...
 //   if (a > b) 0 else f(a) + sum(f, a + 1, b)
  ...
  def sum(f : Int => Int) : (Int,Int) => Int = {
  	...
  	sumF
  };System.out.println("""sum: (f: Int => Int)(Int, Int) => Int""");$skip(688); 
...
/*  def sumOfFactorials(a: Int, b: Int): Int = {
  ...
  def sumOfFactorials = sum(factorial);System.out.println("""sumOfFactorials: => (Int, Int) => Int""");$skip(36); 
  def sumOfInts = sum((x:Int) => x);System.out.println("""sumOfInts: => (Int, Int) => Int""");$skip(34); 
  def sumOfSquares = sum(x=> x*x);System.out.println("""sumOfSquares: => (Int, Int) => Int""");$skip(124); val res$8 = 
